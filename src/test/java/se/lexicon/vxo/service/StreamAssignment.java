...
import se.lexicon.vxo.util.UsefulMethods;
...
//                .collect(new Supplier<Set<LocalDate>>() {
//                             @Override
//                             public Set<LocalDate> get() {
//                                 return new TreeSet<>();
//                             }
//                         }, new BiConsumer<Set<LocalDate>, LocalDate>() {
//                             @Override
//                             public void accept(Set<LocalDate> localDates, LocalDate localDate) {
//                                 localDates.add(localDate);
//                             }
//                         }, new BiConsumer<Set<LocalDate>, Set<LocalDate>>() {
//                             @Override
//                             public void accept(Set<LocalDate> localDates, Set<LocalDate> localDates2) {
//                                 localDates.addAll(localDates2);
//                             }
//                         }
//
//                );
//        .collect(
//                () -> new TreeSet<>(),
//                (localDates, localDate) -> localDates.add(localDate),
//                (localDates, localDates2) -> localDates.addAll(localDates2)
//                );
...
//                .toArray(Person[]::new);
    ...
    public void task8(){
        ...
        optional = people.stream()
//                .min((a,b) -> a.getDateOfBirth().compareTo(b.getDateOfBirth()));
...
//                .min(Comparator.comparing(person -> person.getDateOfBirth()));
    ...
    public void task10(){
        ...
        String expectedSWE = "ONSDAG 19 DECEMBER 2012";
        int personId = 5914;
...
//                .map(date -> date.getDayOfWeek() + " " + date.getDayOfMonth() + " " + date.getMonth() + " " + date.getYear())
    ...
    public void task13(){
        ...
        //Andersson - Stina Andersson, Bert Andersson ......
        //Johansson - Albert Johansson, Tina Johansson, Peter Johansson
